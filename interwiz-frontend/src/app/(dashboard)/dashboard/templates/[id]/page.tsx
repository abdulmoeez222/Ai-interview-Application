...
export default function EditTemplatePage() {
  ...
  useEffect(() => {
    if (template) {
      // Extract questions from assessments
      ...
      template.assessments?.forEach((ta) => {
        ...
        questions.forEach((q, idx) => {
          allQuestions.push({
            ...
            text: q.text,
            type: q.type,
            expectedKeyPoints: q.scoringCriteria?.keyPoints || [],
            order: q.order || idx + 1,
          });
        });
      });
      ...
      form.reset({
        ...
        domain: (template as any).domain || 'ENGINEERING',
  ...
  const updateMutation = useMutation({
    mutationFn: (data: TemplateFormValues) => templatesAPI.update(templateId, {
      title: data.title,
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Update your interview template
        </p>
      </div>
